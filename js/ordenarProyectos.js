...
class Ordenar{
    ...
    mostrarProyectos(){
        ...
        this.proyects.forEach(e => {
            ...
            article.innerHTML += `
                <div class="cardProyectos relative flex flex-col w-full sm:w-1/2 md:w-1/3 lg:w-1/4 max-w-[26rem] rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg mb-4 sm:mb-0" style="box-shadow: #8000FF 0px 5px 15px; padding-bottom: 90px;">
